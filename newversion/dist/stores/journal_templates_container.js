...
function normalizeColumn(column) {
  ...
  return {
    ...
    label: column.label,
    dataType,
    // For boolean columns we may later support various display formats; keep a stable default.
    boolFormat: column?.boolFormat || 'truefalse',
    // Import/export/required flags are introduced later; keep defaults permissive.
